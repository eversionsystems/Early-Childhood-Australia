/**
* Name : user-edit-tabbed-questions-fields.js
* Author : Andrew Schultz
* Purpose : Hide/Display question fields in dashboard user edit screen
*/
...
$j(document).ready(function(){
	...
	$j( '[name="birth_date"]'  ).datepicker({ changeMonth: true,changeYear: true,dateFormat: 'yy-mm-dd', yearRange:'1920:2010', showOn: 'both', buttonImage: myBaseSiteURL + myPluginPath + '/images/calendar.gif'});
	
	//Same for student card expirty
	$j( '[name="student_card_expiry"]' ).datepicker({changeMonth: true,changeYear: true,dateFormat: 'yy-mm-dd', yearRange:'2014:2024', showOn: 'both', buttonImage: myBaseSiteURL + myPluginPath + '/images/calendar.gif'});
	
	//Service established
	$j( '[name="service_established"]' ).datepicker({changeMonth: true,changeYear: true,dateFormat: 'yy-mm-dd', showOn: 'both', buttonImage: myBaseSiteURL + myPluginPath + '/images/calendar.gif'});
